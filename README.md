...
- [x] What problem does the context API help solve?
  ...
  It tries to solve prop drilling where you have state at the top and have to pass it several levels deep into another component.

- [x] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

  The store is a collection of all the current states and is usually injected at the top of the app using a provider.
  An action is used to send data to the store.
  The reducer changes the slice of state by applying an action to the state.

- [x] What is the difference between Application state and Component state? When would be a good time to use one over the other?

  Component State is only available to that component.
  Application state is available at the top of the component and can be passed down to every component.

- [x] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

  redux-thunk is a middleware that allows you to run side effects logic in redux

- [x] What is your favorite state management system you've learned and this sprint? Please explain why!
  
  Given the fact that in the past 4 days, I've been introduced to three new ways of managing state that I'm still trying to get the hang of, I can honestly say I don't understand this question.
  If you really need an answer redux is fun because of syntax like this 'ADD_SMURF'. I've always wondered why code was written like that, now I know.  
